 ...
 * USAGE:
 *
 *     -    See <$106(ele).ptTimeSelect()>
 *
 *
 *
 * LAST UPDATED:
 *
 *         - $106Date: 2012/08/05 19:40:21 $106
 *         - $106Author: paulinho4u $106
 *         - $106Revision: 1.8 $106
 *
 */
...
(function($106){
            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    ...
                    e.find('.ptTimeSelectMin')
                        .bind("click", function(){
                            jQuery.ptTimeSelect.setMin($106(this).text());
                         });

                    e.find('.ptTimeSelectHr')
                        .bind("click", function(){
                            jQuery.ptTimeSelect.setHr($106(this).text());
                         });

                    $106(document).mousedown(jQuery.ptTimeSelect._doCheckMouseClick);
                }//end if
            }
        );
    ...
    jQuery.ptTimeSelect._doCheckMouseClick = function(ev){
        if (!$106("#ptTimeSelectCntr:visible").length) {
            return;
        }
    ...
    jQuery.fn.ptTimeSelect = function (opt) {
        return this.each(function(){
            ...
            var thisOpt = {};
            thisOpt = $106.extend(thisOpt, jQuery.ptTimeSelect.options, opt);
